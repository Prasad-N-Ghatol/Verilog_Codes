...
Description :
--------------------------------------------------
This is a verilog code, to implement a 32-Bit Timer.
...
module Timer_32_Bit (
    ...
    input  [31:0] Preload_Timer_Value_In,

    output        Timer_Running_Flag_Out,
    output        Timer_Rollover_Flag_Out,
    output [31:0] Timer_Count_Out
);
...
// Assignments
// --------------------------------------------------
assign Timer_Count_Out         = Enable_In ? r_Timer_Value    : 32'bZ;
