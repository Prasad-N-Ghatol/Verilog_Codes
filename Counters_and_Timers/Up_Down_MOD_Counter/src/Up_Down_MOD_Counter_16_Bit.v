...
Module :
--------------------------------------------------
Up_Down_MOD_Counter_16_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 16-Bit Up-Down MOD Counter.
...
--------------------------------------------------
*/
module Up_Down_MOD_Counter_16_Bit (
    input         Clk_In,
    input         Reset_In,
    input         Enable_In,
...
// --------------------------------------------------
// Up_Down_MOD_Counter_16_Bit Logic
// --------------------------------------------------
always @ (negedge Clk_In or posedge Reset_In)
    begin
        if (Reset_In)
