...
Description :
--------------------------------------------------
This is a verilog code, to implement a 4-Bit MOD Gray Counter.
...
module Gray_Counter_4_Bit (
    ...
    output [3:0] Counter_Gray_Count_Out
);
...
// Assignments
// --------------------------------------------------
assign Counter_Gray_Count_Out    = Enable_In ? w_Counter_Gray_Count : 4'bZ;
...
assign w_Counter_Gray_Count[3] = r_Counter_Value[3];
