...
Description :
--------------------------------------------------
This is a verilog code, to implement a Decade Counter.
...
assign w_Preload_Counter_Count = (Preload_Counter_Value_In > 4'd9) ? 4'd9 : Preload_Counter_Value_In;
