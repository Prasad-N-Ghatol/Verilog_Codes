...
Module :
--------------------------------------------------
SROM_Dual_Port_4_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 4-Bit Dual Port SROM.
...
(* ramstyle = "M10K" *) reg [3:0] SROM_MEMORY [15:0];
...
initial
    begin
        $readmemh("MEM_INIT_HEX_4_Bit.hex", SROM_MEMORY);
    end
