...
Description :
--------------------------------------------------
This is a verilog code, to implement a 8-Bit Queue.
...
module Queue_8_Bit (
    ...
    input  [7:0]    Queue_Write_Data_In,
    output [7:0]    Queue_Read_Data_Out
);
...
wire [7:0] w_Queue_Write_Data;
reg  [7:0] r_Queue_Read_Data = 8'b0;
...
assign w_Queue_Write_Data           = Enable_In ? Queue_Write_Data_In       : 8'b0;
assign Queue_Read_Data_Out          = Enable_In ? r_Queue_Read_Data         : 8'bZ;
