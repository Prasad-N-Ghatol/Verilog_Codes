...
Description :
--------------------------------------------------
This is a verilog code, to implement a 4-Bit Queue.
...
module Queue_4_Bit (
    ...
    input  [3:0]    Queue_Write_Data_In,
    output [3:0]    Queue_Read_Data_Out
);
...
wire [3:0] w_Queue_Write_Data;
reg  [3:0] r_Queue_Read_Data = 4'b0;
...
assign w_Queue_Write_Data           = Enable_In ? Queue_Write_Data_In       : 4'b0;
assign Queue_Read_Data_Out          = Enable_In ? r_Queue_Read_Data         : 4'bZ;
