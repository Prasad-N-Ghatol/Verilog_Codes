...
Description :
--------------------------------------------------
This is a verilog code, to implement a 32-Bit Queue.
...
module Queue_32_Bit (
    ...
    input  [31:0]   Queue_Write_Data_In,
    output [31:0]   Queue_Read_Data_Out
);
...
wire [31:0] w_Queue_Write_Data;
reg  [31:0] r_Queue_Read_Data = 32'b0;
...
assign w_Queue_Write_Data           = Enable_In ? Queue_Write_Data_In       : 32'b0;
assign Queue_Read_Data_Out          = Enable_In ? r_Queue_Read_Data         : 32'bZ;
