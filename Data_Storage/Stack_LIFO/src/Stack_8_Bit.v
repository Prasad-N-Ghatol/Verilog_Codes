...
Description :
--------------------------------------------------
This is a verilog code, to implement a 8-Bit Stack.
...
module Stack_8_Bit (
    ...
    input  [7:0]    Stack_Write_Data_In,
    output [7:0]    Stack_Read_Data_Out
);
...
wire [7:0] w_Stack_Write_Data;
reg  [7:0] r_Stack_Read_Data = 8'b0;
...
assign w_Stack_Write_Data           = Enable_In ? Stack_Write_Data_In       : 8'b0;
assign Stack_Read_Data_Out          = Enable_In ? r_Stack_Read_Data         : 8'bZ;
