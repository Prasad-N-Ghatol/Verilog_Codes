...
Description :
--------------------------------------------------
This is a verilog code, to implement a 4-Bit Stack.
...
module Stack_4_Bit (
    ...
    input  [3:0]    Stack_Write_Data_In,
    output [3:0]    Stack_Read_Data_Out
);
...
wire [3:0] w_Stack_Write_Data;
reg  [3:0] r_Stack_Read_Data = 4'b0;
...
assign w_Stack_Write_Data           = Enable_In ? Stack_Write_Data_In       : 4'b0;
assign Stack_Read_Data_Out          = Enable_In ? r_Stack_Read_Data         : 4'bZ;
