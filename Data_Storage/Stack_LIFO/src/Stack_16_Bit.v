...
Description :
--------------------------------------------------
This is a verilog code, to implement a 16-Bit Stack.
...
module Stack_16_Bit (
    ...
    input  [15:0]   Stack_Write_Data_In,
    output [15:0]   Stack_Read_Data_Out
);
...
wire [15:0] w_Stack_Write_Data;
reg  [15:0] r_Stack_Read_Data = 16'b0;
...
assign w_Stack_Write_Data           = Enable_In ? Stack_Write_Data_In       : 16'b0;
assign Stack_Read_Data_Out          = Enable_In ? r_Stack_Read_Data         : 16'bZ;
