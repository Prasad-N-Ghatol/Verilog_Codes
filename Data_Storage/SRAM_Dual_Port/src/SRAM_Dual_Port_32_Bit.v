...
Module :
--------------------------------------------------
SRAM_Dual_Port_32_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 32-Bit Dual Port SRAM.
...
module SRAM_Dual_Port_32_Bit (
    ...
    input  [31:0]   Port_2_Write_Data_In,
...
assign w_Port_2_Write_Data      = Enable_In                             ? Port_2_Write_Data_In   : 32'b0;
assign Port_2_Read_Data_Out     = (Enable_In && w_Port_2_Read_Enable)   ? r_Port_2_Read_Data     : 32'bZ;



// --------------------------------------------------
// SRAM_Dual_Port_32_Bit Logic
// --------------------------------------------------
