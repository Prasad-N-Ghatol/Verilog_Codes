...
Module :
--------------------------------------------------
SRAM_Dual_Port_4_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 4-Bit Dual Port SRAM.

This implementation is for a memory region of 16-Words, with each Data Word being a 4-Bit Data.
...
module SRAM_Dual_Port_4_Bit (
    ...
    input  [3:0]    Port_1_Write_Data_In,
    output [3:0]    Port_1_Read_Data_Out,

    input           Port_2_Write_Enable_In,
    input           Port_2_Read_Enable_In,
    input  [3:0]    Port_2_Address_In,
    input  [3:0]    Port_2_Write_Data_In,
    output [3:0]    Port_2_Read_Data_Out
);
...
(* ramstyle = "M10K" *) reg [3:0] SRAM_MEMORY [15:0];
...
wire [3:0] w_Port_1_Write_Data;
reg  [3:0] r_Port_1_Read_Data = 4'b0;

wire       w_Port_2_Write_Enable;
wire       w_Port_2_Read_Enable;
wire [3:0] w_Port_2_Address;
wire [3:0] w_Port_2_Write_Data;
reg  [3:0] r_Port_2_Read_Data = 4'b0;
...
assign w_Port_1_Write_Data      = Enable_In                             ? Port_1_Write_Data_In   : 4'b0;
assign Port_1_Read_Data_Out     = (Enable_In && w_Port_1_Read_Enable)   ? r_Port_1_Read_Data     : 4'bZ;
...
assign w_Port_2_Write_Data      = Enable_In                             ? Port_2_Write_Data_In   : 4'b0;
assign Port_2_Read_Data_Out     = (Enable_In && w_Port_2_Read_Enable)   ? r_Port_2_Read_Data     : 4'bZ;



// --------------------------------------------------
// SRAM_Dual_Port_4_Bit Logic
// --------------------------------------------------
