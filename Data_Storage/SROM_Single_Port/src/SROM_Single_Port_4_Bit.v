...
Module :
--------------------------------------------------
SROM_Single_Port_4_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 4-Bit Single Port SROM.
...
The "MEM_INIT_HEX_4_Bit.hex" file contains the set of 16 Words of 4-Bit Data, which is used as the ROM contents.
