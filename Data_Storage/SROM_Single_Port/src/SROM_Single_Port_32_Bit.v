...
Module :
--------------------------------------------------
SROM_Single_Port_32_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 32-Bit Single Port SROM.
...
The "MEM_INIT_HEX_32_Bit.hex" file contains the set of 16 Words of 32-Bit Data, which is used as the ROM contents.
...
--------------------------------------------------
*/
module SROM_Single_Port_32_Bit (
    input           Clk_In,
    input           Enable_In,
