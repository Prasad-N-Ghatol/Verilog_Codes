...
Module :
--------------------------------------------------
SROM_Single_Port_8_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 8-Bit Single Port SROM.
...
The "MEM_INIT_HEX_8_Bit.hex" file contains the set of 16 Words of 8-Bit Data, which is used as the ROM contents.
...
(* ramstyle = "M10K" *) reg [7:0] SROM_MEMORY [15:0];
...
initial
    begin
        $readmemh("MEM_INIT_HEX_8_Bit.hex", SROM_MEMORY);
    end
