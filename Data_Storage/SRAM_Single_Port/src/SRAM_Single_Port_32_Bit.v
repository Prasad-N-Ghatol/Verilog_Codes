...
Module :
--------------------------------------------------
SRAM_Single_Port_32_Bit


--------------------------------------------------
Description :
--------------------------------------------------
This is a verilog code, to implement a 32-Bit Single Port SRAM.
...
--------------------------------------------------
*/
module SRAM_Single_Port_32_Bit (
    input           Clk_In,
    input           Enable_In,
    ...
    input  [31:0]   Port_1_Write_Data_In,
...
assign w_Port_1_Write_Data      = Enable_In                             ? Port_1_Write_Data_In   : 32'b0;
assign Port_1_Read_Data_Out     = (Enable_In && w_Port_1_Read_Enable)   ? r_Port_1_Read_Data     : 32'bZ;



// --------------------------------------------------
// SRAM_Single_Port_32_Bit Logic
// --------------------------------------------------
